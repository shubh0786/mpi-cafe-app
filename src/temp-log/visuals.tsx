...
export const FridgeIllustration = ({ size = 130, className = '' }: { size?: number; className?: string }) => (
  <svg viewBox="0 0 100 140" width={size} height={size * 1.4} className={className}>
    <defs>
      <linearGradient id="tl-fbody" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0%" stopColor="#d4dff0" /><stop offset="100%" stopColor="#bcc8dc" /></linearGradient>
      <linearGradient id="tl-ffreezer" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#002e6d" /><stop offset="100%" stopColor="#001a3f" /></linearGradient>
      <linearGradient id="tl-fglass" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="rgba(255,255,255,0.5)" /><stop offset="50%" stopColor="rgba(255,255,255,0.15)" /><stop offset="100%" stopColor="rgba(255,255,255,0.3)" /></linearGradient>
      <filter id="tl-fshadow"><feDropShadow dx="0" dy="5" stdDeviation="6" floodColor="#002e6d" floodOpacity="0.15" /></filter>
    </defs>
    <rect x="12" y="5" width="76" height="130" rx="8" fill="url(#tl-fbody)" filter="url(#tl-fshadow)" stroke="#7a8eaa" strokeWidth="1" />
    <rect x="12" y="5" width="76" height="40" rx="8" fill="url(#tl-ffreezer)" stroke="#002e6d" strokeWidth="1" />
    <rect x="16" y="50" width="68" height="80" rx="5" fill="url(#tl-fglass)" />
